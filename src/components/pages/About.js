      ...
      <div className="min-vh-100">
        <div className="row m-2 p-3 bg-success">
          ...
          <p className="col">
            ...
            Stack Web Development bootcamp! <br /> I was born in Mexico and
            raised in Charlotte. I learned Spanish and English at the same time
            and consider myself a great communicator in both languages. <br /> A
